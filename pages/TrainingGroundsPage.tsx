...
import { JWSTVisual } from '../components/JWSTVisual';
...
export default function TrainingGroundsPage() {
  ...
  return (
    <div style={{ animation: 'fade-in-up 0.8s ease-out' }}>
      <Header title="Training Grounds" subtitle="Hone your skills with interactive challenges" />
      
      {/* Intro Section */}
      <div className="relative text-center pt-4 pb-12 px-4 flex flex-col items-center overflow-hidden">
        <JWSTVisual />
        <div className="relative z-10 mt-8">
          <h3 className="text-3xl font-bold font-orbitron">Welcome to the Training Grounds</h3>
          <p className="text-gray-400 mt-2 max-w-lg mx-auto">Test your knowledge and intuition with a series of interactive simulations and challenges designed for aspiring astronomers.</p>
          <button
